  ...
  <form name="multiple" id="registerform" action="previa_mensaje.php" method="get" >
    <div id="container">
      <div id="content">
          ...
          <select data-placeholder="Seleccione Usuarios..." class="chosen-select"  style="width:100%;" tabindex="10" id="destino[]" name="destino[]" >
            <option value=""></option>
            <?php do {  ?>
            <option value=""><?php echo $row_usuarios['nombres']; ?> <?php echo $row_usuarios['ci']; ?></option>
