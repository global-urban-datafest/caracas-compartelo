...
<div data-role="navbar"  data-grid="a" data-theme="b" >
	<ul>
    		<li><a href="compras.php" class="ui-btn-active ui-state-persist"  rel="external">Registrar Compra Simple</a></li>
			<li><a href="compras_referida.php" rel="external"  >Registrar Compra Referida</a></li>
...
<li data-role="list-divider" data-icon="search">Clientes</li>
				<?php do { ?><li data-filtertext="<?php echo $row_usuarios['id_usuario']; ?> <?php echo $row_usuarios['nombres']; ?> <?php echo $row_usuarios['ci']; ?> "><a href="compras2.php?id_usuario=<?php echo $row_usuarios['id_usuario']; ?>"  rel="external"><?php echo $row_usuarios['nombres']; ?></a></li>
				 <?php } while ($row_usuarios = mysql_fetch_assoc($usuarios)); ?>
    </ul>
<a href="registro_cliente.php"  rel="external">Registrar Nuevo Cliente</a>
</div><!-- /content -->
