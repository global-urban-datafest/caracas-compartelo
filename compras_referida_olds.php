...
<li data-role="list-divider" data-icon="search">Clientes</li>
				<?php do { ?><li data-filtertext="<?php echo $row_usuarios['id_usuario']; ?> <?php echo $row_usuarios['nombres']; ?> <?php echo $row_usuarios['ci']; ?> "><a href="compras_referida2.php?id_usuario=<?php echo $row_usuarios['id_usuario']; ?>"  rel="external"><?php echo $row_usuarios['nombres']; ?></a></li>
