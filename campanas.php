...
<div data-role="navbar"   data-theme="b" >
	<ul>
    		<li><a href="campanas.php" class="ui-btn-active ui-state-persist"  rel="external">Mensaje Masivo (SMS)</a></li>
			<li><a href="mensajes_seleccionados.php" rel="external"  >Mensaje a Seleccionados</a></li>
            <li><a href="import.php" rel="external"  >Importar Base de Datos de Clientes</a></li>
...
<h3>Ingrese el Mensaje que se enviar&aacute; a TODOS sus clientes registrados (<?php echo $totalRows_usuarios ?>)</h3>
<div class="ui-body ui-body-b">
<div id="errorBox"><ul></ul></div>
<form action="previa_mensaje.php" method="get"  data-ajax="false" class="ui-body ui-body-a ui-corner-all" id="registerForm">
<fieldset class="ui-grid-a" align="center" >
			 
	        <div class="ui-block-a"><textarea cols="40" rows="10" name="mensaje" id="mensaje" placeholder="Ingrese mensaje a enviar..." maxlength="140" class="required"></textarea>
	         <br>  

			<label for="flip-1">Enviar Mensajes de Texto (SMS)</label>
<select name="flip-1" id="flip-1" data-role="slider">
	...
	<option value="on" selected>On</option>
			...
			<label for="flip-1">Realizar Llamadas de Voz (se convierte el texto a voz)</label>
<select name="flip-1" id="flip-1" data-role="slider">
	<option value="off">Off</option>
	<option value="on">On</option>
</select> 
            <input name="usuarios" type="hidden" value="<?php echo $totalRows_usuarios ?>">
            <input name="destino" type="hidden" value="todos">
		  <button type="submit" data-theme="b" name="submit" value="submit-value">Enviar Mensaje</button></div>
