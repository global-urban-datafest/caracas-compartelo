...
$(function() {
var availableTags = [
<?php do { ?> "<?php echo $row_usuarios['nombres']; ?> <?php echo $row_usuarios['ci']; ?> #<?php echo $row_usuarios['id_usuario']; ?>",
...
<div>
<form action="compras2.php" method="get"  data-ajax="false" class="ui-body ui-body-a ui-corner-all" id="registerForm">
<input id="tags" type="text" value="" name="nombresx" />
<button type="submit" data-theme="b" name="submit" value="submit-value">Registrar Compra</button>
</form>		
<br>
