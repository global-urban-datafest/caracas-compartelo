...
<form action="registro2.php" method="get"  data-ajax="false" class="ui-body ui-body-a ui-corner-all" id="registerForm">
<fieldset class="ui-grid-a" align="center">
			 
	        <div class="ui-block-a">Nombres y Apellidos
	          <input type="text" name="nombres" id="nombres" class="required" value=""  />
              <input type="hidden" name="cedula" id="cedula"   value="<?php echo $_GET['cedula']; ?>"  />
              <input type="hidden" name="telf" id="telf"   value="<?php echo $_GET['telf']; ?>"  />
