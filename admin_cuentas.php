...
$query_usuarios = "SELECT * FROM usuarios_empresas,empresas WHERE empresas.empresa_id=usuarios_empresas.empresa_id";
...
<div data-role="navbar" class="nav-glyphish-example" data-grid="c" >
	<ul>
			...
			<li><a href="admin_cuentas.php" id="skull" data-icon="custom"  rel="external" class="ui-btn-active ui-state-persist" >Cuentas</a></li>
...
<ul data-role="listview" data-theme="c" data-dividertheme="d" data-filter="true" data-inset="true" data-filter-placeholder="Ingrese datos del usuarios o empresa">
<li data-role="list-divider">Cuentas de Usuario</li>
						<?php do { ?><li><a href="index.html"><img src="http://curriculum.eku.edu/sites/curriculum.eku.edu/files/people_images/Male_User_Icon_clip_art_hight.png" />
				
					<h3><?php echo $row_usuarios['usuario_login']; ?> (<?php echo $row_usuarios['empresa_nombre']; ?>)</h3>
					<p><strong>Email:</strong><?php echo $row_usuarios['usuario_email']; ?> </p>
					<p><strong>Pass:</strong><?php echo $row_usuarios['usuario_pass']; ?></p>
                    <p><strong>Estatus usuario:</strong><?php echo $row_usuarios['usuario_status']; ?></p>
...
<a href="add_user.php?" data-role="button"  data-theme="b" rel="external">Agregar Nueva Cuenta de Usuario</a>
</div><!-- /content -->
