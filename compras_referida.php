...
<div>
<form action="compras_referida2.php" method="get"  data-ajax="false" class="ui-body ui-body-a ui-corner-all" id="registerForm">
<h3>Paso 1:Datos del Cliente</h3>
<?php if ($_GET['error']==1) {echo "<h3>Verifique los datos del cliente!!!</h3>";}?>
 
<input id="tags" type="text" value="" name="nombresx" placeholder="ingrese cualquier dato del cliente (nombre, apellido o cedula)..." /><br>
<button type="submit" data-theme="b" name="submit" value="submit-value">Continuar</button>
</form>
<br>
<a href="registro_cliente.php?viene=referida"  rel="external">Registrar Nuevo Cliente</a>
</div><!-- /content -->
