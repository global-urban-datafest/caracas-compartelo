...
<body <?php if ($_GET['registrado']==1) { ?>onLoad="alert('Cliente Registrado Exitosamente')" <?php } ?>> 
...
<input id="tags" type="text" value="" name="nombresx" placeholder="ingrese cualquier dato del cliente (nombre, apellido o cedula)..." />
