...
<div data-role="navbar" class="nav-glyphish-example" data-grid="d" >
	<ul>
    		<li><a href="#" id="chat" data-icon="custom" class="ui-btn-active ui-state-persist">Registrar Compra</a></li>
...
<div data-role="navbar"  data-grid="a" data-theme="b" >
	<ul>
    		<li><a href="#" >Registrar Compra Simple</a></li>
			<li><a href="#" class="ui-btn-active ui-state-persist"  >Registrar Compra Referida</a></li>
...
<h3>Paso 2:Quien refirio al Cliente?</h3>
<ul data-role="listview" data-filter="true"  data-inset="true" data-filter-placeholder="Ingrese cualquier dato del cliente como nombre, apellido o  c&eacute;dula" >
<li data-role="list-divider" data-icon="search">Clientes</li>
				<?php do { ?><li data-filtertext="<?php echo $row_usuarios['id_usuario']; ?> <?php echo $row_usuarios['nombres']; ?> <?php echo $row_usuarios['ci']; ?> "><a href="compras_referida3.php?referido_por=<?php echo $row_usuarios['id_usuario']; ?>"><?php echo $row_usuarios['nombres']; ?></a></li>
